...
# En caché, les packages utilisés pour la mise en page des éléments graphiques de la fiche
...
Pour rejouer la préparation des données (ou l'adapter à d'autres indicateurs), se reporter à ce [script R](https://github.com/rysebaert/mta_rzine/blob/main/prepa.R). 
...
- `metro` : celle des métropoles, également utilisée pour l'habillage cartographique. 
- `com` : celle des communes, qui contient des données socio-économiques.
- `iris` : même chose mais pour les IRIS. 
