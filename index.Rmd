...
**3) base-cc-emploi-pop-active-2016.xls** : Des indicateurs sur l'emploi au lieu de travail et la population active occupée en 2016, mis à disposition par [l'INSEE](https://www.insee.fr/fr/statistiques/4171446?sommaire=4171473){target="_blank"}. 

 **4) base-ic-logement-2016.xls** : Des indicateurs décrivant le niveau de motorisation des ménages à l'échelle des IRIS, distribué par l'[INSEE](https://www.insee.fr/fr/statistiques/4228432){target="_blank"}.  Il ne sera utilisé qu'en toute fin de document pour montrer la possible transposition à d'autres espaces d'étude et d'autres mailles territoriales.
